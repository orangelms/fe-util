 ...
 */
export function isEmpty(value: string | null | object | undefined | any) {
    const result =  (
 ...
 * @param obj1 object 1
 * @param obj2 object 2
 * @param shallow shallow compare 浅比较默认false
 * @returns
 */
export function isEqual(obj1: any, obj2: any, shallow = false): boolean {
    ...
    function deepEqual(a: any, b: any, level = 1): boolean {
      ...
      // console.warn(!circular, 'Warning: There may be circular references');
      if (circular) {
        return false;
      }
      if (a === b) {
